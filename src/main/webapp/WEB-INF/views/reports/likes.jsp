	...
	<table id="report_list">
		<tbody>
			...
			<c:forEach var="likes" items="${likes}" varStatus="status">
				<fmt:parseDate value="${likes.createdAt}" pattern="yyyy-MM-dd" var="reportDay" type="date" />

				<tr class="row${status.count % 2}">
					<td class="like_name"><c:out value="${likes.employeeId}" /></td>
					<td class="like_date"><fmt:formatDate value='${likes.createdAt}' pattern='yyyy-MM-dd' /></td>
				</tr>
			</c:forEach>
		</tbody>
	</table>
